...
const Product: React.FC<ProductProps> = ({product, openModal}) => {
    ...
    return (
        <div className="border-2 border-gray-300 p-4 text-center flex-1 max-w-60 min-w-60 bg-white mx-6 rounded-lg overflow-hidden mb-6 flex flex-col justify-between">
            <div>
